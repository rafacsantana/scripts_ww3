    ...
    for expt=expts
      ...
      for i=1:length(dcol)
        ...
        if correct_model==-1;
          ...
          hold on
          plot([0 9],[0 9],'--','color',[.7 .7 .7],'linewidth',2)
        ...
        if correct_model<=0;
          ...
          text(1,yd-dsz,['RMSE=',num2str(mod_rmse,'%.2f'),' m']                ,'fontsize',10,'fontweight','bold');
          text(1,yd-dsz*2,['bias=',num2str(mod_bias,'%.2f'),' m']              ,'fontsize',10,'fontweight','bold');
          text(1,yd-dsz*3,['r=',num2str(mod_corr,'%.2f')]                 ,'fontsize',10,'fontweight','bold');
        elseif correct_model==1;
          %  legh=[legh,{[expt,' rmse=',num2str(mod_rmse,'%.2f'),' corr=',num2str(mod_corr,'%.2f'),', bias=',num2str(mod_bias,'%.2f')]}];
